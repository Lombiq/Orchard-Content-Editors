...
; (function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        setDate: function (value, dateFormat) {
            ...
            var minDate = plugin.$datepicker.datepicker("option", "minDate");
            var maxDate = plugin.$datepicker.datepicker("option", "maxDate");
            ...
            plugin.$datepicker.datepicker("setDate", date);
