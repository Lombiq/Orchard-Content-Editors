 ...
 *              This means that, although we attach a Selectize Editor plugin to an element in the DataTable, 
 *              it's lost as the jQuery object is not used to append the new content.
 * @version     1.0
